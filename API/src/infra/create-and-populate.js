...
VALUES 
    (1, 'Joao', 'Joao.oliveira@bol.com.br', '***'),
    (2, 'Marcus Aurelio', 'Marcus.aurelio@gmail.com', '****'),
    (3, 'Ricardo', 'ricardo@yahoo.com', '****'),
    (4, 'Paulinho ', 'Paulinho_fl@yahoo.com', '****'),
    (5, 'Daniel', 'Daniel_fl@yahoo.com', '****'),
    (6, 'Bruno Estrela', 'bruno_estrela@yahoo.com', '****'),
    (7, 'Rosalia', 'rosa_ria@yahoo.com', '****'),
    (8, 'Joao Pedro', 'joao_fl@yahoo.com', '****')
